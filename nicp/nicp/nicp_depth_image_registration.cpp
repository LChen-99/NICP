...
int main(int argc, char **argv) {
  ...
  // nicp::CorrespondenceFinderNN correspondenceFinderNN;
  // correspondenceFinderNN.setFlatCurvatureThreshold(0.02f);
  // correspondenceFinderNN.setInlierCurvatureRatioThreshold(0.5f);
  // correspondenceFinderNN.setInlierDistanceThreshold(0.5f);
  // correspondenceFinderNN.setInlierNormalAngularThreshold(0.95f);
