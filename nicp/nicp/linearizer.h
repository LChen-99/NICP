...
namespace nicp {
  ...
  public:
     ...
     *  @see setT()
     */
    inline Isometry2f T() const { return _T; }  
     ...
     *  @see b()
     */
    inline Matrix3f H() const { return _H; }  
     ...
     *  @see H()
     */
    inline Vector3f b() const { return _b; }  
  ...
  protected:
    ...
    Isometry2f _T; /**< Isometry transformation used by the Linearizer to update the point clouds to align. */
    float _inlierMaxChi2; /**< Chi square error threshold used by the Linearizer update step. */

    Matrix3f _H; /**< Hessian matrix of the least squares problem computed by the Linearizer. */
    Vector3f _b; /**< b vector of the least squares problem computed by the Linearizer. */
    float _error; /**< Error generated by the Linearizer after the update step. */
    int _inliers; /**< Inliers found by the Linearizer after the update step. */
    bool _robustKernel; /**< Bool value used to say to the Linearizer to use robust kernel mode or not. */
